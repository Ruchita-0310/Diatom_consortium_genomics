#!/usr/bin/env python3
"""Create the first compact 24-gene expression + RBH figure table."""

import argparse
import csv

SELECTED = [
    "NODE_67.p4", "NODE_63.p1", "NODE_30207.p1", "NODE_7928.p2",
    "NODE_8468.p1", "NODE_18074.p1", "NODE_20723.p1", "NODE_10495.p2",
    "NODE_8343.p1", "NODE_5705.p1", "NODE_9414.p1", "NODE_10595.p1",
    "NODE_14611.p3", "NODE_5837.p1", "NODE_1090.p2", "NODE_4370.p1",
    "NODE_971.p2", "NODE_12386.p1", "NODE_12193.p1", "NODE_21007.p2",
    "NODE_2665.p1", "NODE_10018.p1", "NODE_23676.p1", "NODE_26832.p1",
]

ORGANELLE_NOT_ASSESSED = {"NODE_67.p4", "NODE_63.p1"}
